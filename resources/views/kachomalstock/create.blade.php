            ...
            <div class="card">
                ...
                <div class="card-body"> 
                    <div class="the-box no-border">
                        ...
                        {!! Form::open(array('url' => URL::to('me-admin/kachomalstock/create'), 'method' => 'post', 'class' => 'bf', 'files'=> true)) !!}
                        <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                         <div class="row"> 

                            <div class="col-md-6"> 
                                <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="name">{{ __('Select Kachomal') }}</label> 
                                    {!! Form::select('name',$kachomal ,null, array('class' => 'form-control js-example-basic-single', 'placeholder'=>'Select Kachomal','required' => 'required')) !!}
                                </div>  
