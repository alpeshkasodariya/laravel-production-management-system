                        ...
                        <form method="post" action="{{ route('user.store') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('firstname') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="firstname" id="input-firstname" class="form-control form-control-alternative{{ $errors->has('firstname') ? ' is-invalid' : '' }}" placeholder="{{ __('Firstname') }}" value="{{ old('firstname') }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                                 ...
                                 <div class="form-group{{ $errors->has('user_type') ? ' has-danger' : '' }}">
                                   ...
                                   {!! Form::select('user_type',  (['' => 'Select Type','admin' =>'Admin','carer' =>'carer'] ), null,['class' => 'form-control form-control-alternative','id'=>'user_type','required' => 'required']) !!}
