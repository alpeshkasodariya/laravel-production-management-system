            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">{{ __('Add Delivery') }}</h3>
                        </div>
                ...
                <div class="card-body"> 
                    <div class="the-box no-border">
                        ...
                        {!! Form::open(array('url' => URL::to('me-admin/delivery/create'), 'method' => 'post', 'class' => 'bf', 'files'=> true)) !!}
                       ...
                       <div class="row"> 
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group{{ $errors->has('total_price') ? ' has-danger' : '' }}">
                                    ...
                                    {!! Form::number('total_price_pending', null, array('class' => 'form-control form-control-alternative','placeholder'=>'total_price')) !!}
                                </div> 
                            </div> 
                            <div class="col-sm-12">  
