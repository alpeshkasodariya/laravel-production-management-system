@extends('layouts.front', ['pageSlug' => 'dashboard'])
    ...
    <div class="col-lg-12">
         <div class="card card-chart">
           <div class="card-header dashboarddiv">
                    ...
                    <h3 class="card-title">
                        <button id="l1" class="l4 dashboardtbn btn btn-lg btn-darker">Total Amount <small>(Rs)</small> : <b><?php echo $fulltotalpricep[0]+$fulltotalpricep[1]+$fulltotalpricep[2]+$fulltotalpricep[3] ?><Br></b></button>
       ...
       <div class="col-lg-6">
         ...
         <div class="col-lg-6">
           ...
           <div class="card-header dashboarddiv">
                    ...
                    <h3 class="card-title">
                        <button id="l1" class="l1 dashboardtbn btn btn-sm btn-primary"> Deliver250gm<br><b>(Rs)<?php echo $totalpriced[6] ?></b></button>
                        <button id="l1" class="l2 dashboardtbn btn btn-sm btn-primary"> Deliver500gm<br><b>(Rs)<?php echo $totalpriced[7] ?> </b></button>
                    </h3>
                    <h3 class="card-title">
    ...
    <div class="col-lg-12">
         <div class="card card-chart">
           <div class="card-header dashboarddiv">
                    ...
                    <h3 class="card-title">
                        <button id="l1" class="l4 dashboardtbn btn btn-lg btn-darker">Total Amount<small>(Rs)</small>:  <b><?php echo $fulltotalpriced[0]+$fulltotalpriced[1]+$fulltotalpriced[2]+$fulltotalpriced[3] ?><Br></b></button>
