                ...
                <div class="card-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col-4 text-right">
                            <a href="{{ URL::to('me-admin/order') }}" class="btn btn-sm btn-primary">{{ __('Back to list') }}</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="the-box no-border">
                        ...
                        <div class="has-error">
                         ...
                         {!! Form::model($order, array('url' => URL::to('me-admin/order/' . $order->id.'/edit'), 'method' => 'post', 'class' => 'bf', 'files'=> true)) !!}
