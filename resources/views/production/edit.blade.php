            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">{{ __('Edit Production') }}</h3>
                        </div>
                        <div class="col-4 text-right">
                            <a href="{{ URL::to('me-admin/production') }}" class="btn btn-sm btn-primary">{{ __('Back to list') }}</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="the-box no-border">
                        ...
                        {!! Form::model($production, array('url' => URL::to('me-admin/production/' . $production->id.'/edit'), 'method' => 'post', 'class' => 'bf', 'files'=> true)) !!}
                         ...
                         <div class="row"> 
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group{{ $errors->has('total_price') ? ' has-danger' : '' }}">
                                    ...
                                    {!! Form::number('total_price', null, array('class' => 'form-control form-control-alternative','placeholder'=>'total_price','readonly'=>'readonly')) !!}
                                </div> 
                            </div> 
                            <div class="col-sm-12">  
