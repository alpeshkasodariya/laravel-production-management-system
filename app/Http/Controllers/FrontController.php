...
class FrontController extends Controller {
    ...
    public function index() {
        ...
        return view('front', compact('total','totalprice','fulltotalprice','fullKg','totalp','totalpricep','fulltotalpricep','fullKgp','totald','totalpriced','fulltotalpriced','fullKgd','kaju','badam','kachomal'));
    }
